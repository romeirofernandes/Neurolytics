        ...
        <Card className="border-2">
          ...
          <CardContent className="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Please Read Carefully:</strong> This consent form explains the research study and your rights as a participant. 
              ...
              <div className="space-y-4">
                {consentForm.dataHandling.anonymity && (
                  <Alert>
                    ...
                    <AlertDescription>
                      <strong>Your Data is Anonymous:</strong> {consentForm.dataHandling.anonymityDescription}
                    </AlertDescription>
                  </Alert>
                )}
            ...
            <section className="border-t pt-6">
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                ...
                <Alert>
                  <AlertDescription>
                    <strong>No Penalties for Withdrawal:</strong> {consentForm.withdrawalRights.withdrawalConsequences}
                  </AlertDescription>
                </Alert>
              </div>
            </section>
            ...
            {consentForm.irbApproval?.approved && (
              <Alert>
                <FaCheckCircle className="h-4 w-4" />
                <AlertDescription>
                  <strong>Ethics Approval:</strong> This study has been reviewed and approved by {consentForm.irbApproval.institution}.
          ...
          <CardFooter className="border-t p-6 flex-col gap-4">
            {/* Consent Agreement */}
            <div className="w-full border rounded-lg p-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer p-3 hover:bg-accent rounded-lg transition-colors">
                <input
                  type="checkbox"
