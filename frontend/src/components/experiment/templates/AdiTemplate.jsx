...
export const StroopTemplate = ({ onComplete }) => {
  ...
  const words = ['RED', 'GREEN', 'BLUE']; // Reduced to 3 words
  const colors = { RED: 'red', GREEN: 'green', BLUE: 'blue' }; // Reduced to 3 colors
  const keys = { r: 'RED', g: 'GREEN', b: 'BLUE' }; // Reduced to 3 keys
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-2"> {/* Changed to grid-cols-3 */}
        ...
        <div className="text-center text-xs text-muted-foreground">Keyboard shortcuts: R, G, B</div> {/* Updated shortcuts */}
      </CardContent>
    </Card>
  );
};