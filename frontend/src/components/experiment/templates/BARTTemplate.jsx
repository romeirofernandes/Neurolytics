...
export const BARTTemplate = ({ onComplete }) => {
  ...
  const balloonColors = {
    ...
    green: { color: '#22C55E', maxAvg: 10 } // training
  };
  ...
  const handlePump = () => {
    ...
    if (newPumps >= maxPumps) {
      ...
      setResults([...results, {
        balloonColor,
        balloonCount,
        timesPumped: newPumps,
        explosion: 1,
        earningsThisBalloon: 0,
  ...
  const handleCollect = () => {
    ...
    setResults([...results, {
      ...
      timesPumped: pumps,
      explosion: 0,
      earningsThisBalloon: currentEarnings,
    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-4">
        <div className="flex justify-between text-sm">
          <div>Current Trial: ${currentEarnings.toFixed(2)}</div>
          <div>Total Earnings: ${earnings.toFixed(2)}</div>
        </div>
        ...
        <div className="flex justify-center items-center h-96 relative">
          <div
            ...
            style={{
              ...
              backgroundColor: exploded ? '#EF4444' : balloonColors[balloonColor].color,
        ...
        <div className="flex gap-4 justify-center">
          <Button onClick={handlePump} disabled={exploded} size="lg">
            Pump (+$0.05)
          </Button>
          <Button onClick={handleCollect} disabled={exploded} variant="outline" size="lg">
            Collect Money
          </Button>
        </div>
